...
class PlatformEnvironment:
    def __init__(self, worker_env, n_workers_pool=100):
...
def train_multitask_agent(episodes=1000, batch_size=32, n_tasks_per_episode=100, n_workers_pool=100):
    tracemalloc.start()
...
if __name__ == "__main__":
    ...
    results = train_multitask_agent(episodes=1000, batch_size=32, n_tasks_per_episode=100)

    stats_df = pd.DataFrame({
        '指标': ['平台利润', '工人利润', '任务时间', '单步耗时', '接受率'],
        '均值': [
            results['profit_stats']['mean'],
            results['worker_profit_stats']['mean'],
            results['task_time_stats']['mean'],
            results['step_time_stats']['mean'],
            results['accept_rate_stats']['mean']
        ],
        '方差': [
            results['profit_stats']['var'],
            results['worker_profit_stats']['var'],
            results['task_time_stats']['var'],
            results['step_time_stats']['var'],
            results['accept_rate_stats']['var']
        ],
        '95%CI下限': [
            results['profit_stats']['ci95_lower'],
            results['worker_profit_stats']['ci95_lower'],
            results['task_time_stats']['ci95_lower'],
            results['step_time_stats']['ci95_lower'],
            results['accept_rate_stats']['ci95_lower']
        ],
        '95%CI上限': [
            results['profit_stats']['ci95_upper'],
            results['worker_profit_stats']['ci95_upper'],
            results['task_time_stats']['ci95_upper'],
            results['step_time_stats']['ci95_upper'],
            results['accept_rate_stats']['ci95_upper']
        ],
        '波动系数': [
            results['profit_stats']['cv'],
            results['worker_profit_stats']['cv'],
            results['task_time_stats']['cv'],
            results['step_time_stats']['cv'],
            results['accept_rate_stats']['cv']
        ]
    })
    stats_df.to_csv('statistics/workers_ten.csv', index=False, encoding='utf-8-sig')
    print("\n统计结果已保存到 100workers.csv")